...
import top.parak.remoting.transport.netty.client.NettyRpcClient;
...
/**
 * Dynamic proxy class.
 * <p> When a dynamic proxy object calls a method, it actually calls the following invoke method.
 * It is precisely because of the dynamic proxy that the remote method called by the client
 * is like calling the local method (the intermediate process is shielded)
 *
 * @author KHighness
 * @since 2021-09-11
 */
